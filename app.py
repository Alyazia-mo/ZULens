...
# Initialize AI-based inappropriate content detection model (using smaller distilbert model)
classifier = pipeline("text-classification", model="distilbert-base-uncased")  # Smaller model
...
def submit_review():
    ...
    # Clear unused memory to avoid memory issues
